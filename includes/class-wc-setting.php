...
class PayXpertOption {
	...
	public function payxpert_all_settings( $settings, $current_section ) {
		...
		if ( $current_section == 'payxpert' ) {
			...
			$settings_payxpert[] = array(
				'name'     => __( 'Seamless Checkout version', 'payxpert' ),
				'desc_tip' => __( 'Version to be fetched when using Seamless Checkout', 'payxpert' ),
				'id'       => 'payxpert_seamless_version',
				'default'  => '1.4.8',
				'type'     => 'text',
				'desc'     => __( 'Version to be fetched when using Seamless Checkout', 'payxpert' ),
			);

			$settings_payxpert[] = array(
				'name'     => __( 'Integrity hash', 'payxpert' ),
				'desc_tip' => __( 'The file hashing value of the Seamless Checkout script', 'payxpert' ),
				'id'       => 'payxpert_seamless_hash',
				'default'  => 'sha384-M9Dgri87tBDqvrhRCh0JnpnvLvsnGLsc0UKffq72bWXUJLJYsy2qLpbPMA2WW1AO',
				'type'     => 'text',
				'desc'     => __( 'The file hashing value of the Seamless Checkout script', 'payxpert' ),
			);
