...
class WC_Gateway_PayXpert_Alipay extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description = __( 'Alipay payment method', 'payxpert' );
		...
		$this->title             = __( 'Alipay via PayXpert', 'payxpert' );
		$this->description       = '<img class="payxpert-logo" src="' . PX_ASSETS . '/img/alipay.svg' . '" > ';
		$this->testmode          = 'no';
