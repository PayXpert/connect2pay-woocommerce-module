    ...
    */
    ...
    public function payxpert_process_payment($order_id, $type, $returnurl, $returnname) {
        ...
        if ($result !== false) {
            ...
            if($this->is_iframe_on()) $url = $orderdetails->get_checkout_payment_url(true);
    ...
    public function seamless_credit_card_process_payment($order_id){
        ...
        update_option( 'payxpart_store_'.$_POST['merchantToken'].'_'.$_POST['transactionId'].'_'.$_POST['paymentstatus'] , 'Yes Used Once!' );
