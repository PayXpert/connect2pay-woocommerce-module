 ...
 */
class PaymentTokenExpiredException extends PayxpertException
{
    /**
     ...
     */
    public function __construct(string $message = 'Payment token expired.', int $code = 0, \Exception $previous = null)
    {
