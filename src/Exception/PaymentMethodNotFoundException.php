 ...
 */
class PaymentMethodNotFoundException extends PayxpertException
{
    /**
     ...
     */
    public function __construct(string $message = 'Payment method not found.', int $code = 0, \Exception $previous = null)
    {
