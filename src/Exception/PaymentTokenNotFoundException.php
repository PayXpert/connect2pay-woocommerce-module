 ...
 */
class PaymentTokenNotFoundException extends PayxpertException
{
    /**
     ...
     */
    public function __construct(string $message = 'No payment token found.', int $code = 0, \Exception $previous = null)
    {
